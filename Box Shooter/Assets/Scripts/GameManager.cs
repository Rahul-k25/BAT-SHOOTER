...
public class GameManager : MonoBehaviour {
	...
	public string MainMenuPageToLoad;
...
*/
	...
	void EndGame() {
		...
		*/
		...
		if(score>PlayerPrefs.GetInt("highestScore")){
             ...
             //PlayerPrefs.SetString("highestScore_PlayerName", GAME_Manager.gm1.PlayerName.text.ToString());
	...
	public void MainMenu ()
	{
		// we are just loading a scene (or reloading this scene)
		// which is an easy way to restart the level
        SceneManager.LoadScene(MainMenuPageToLoad);
	}
